...
export const InfiniteMovingCards = ({
  ...
  return (
    <div className="relative min-h-[450px] md:min-h-[600px] w-full overflow-hidden">
      <div
        ref={containerRef}
        className={cn(
      ...
      >
        ...
        >
          {items.map((item, idx) => (
            <li
              className="w-[85vw] md:w-[60vw] h-full relative rounded-2xl border border-b-0 
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 flex gap-4 z-20 mb-4">
        <button
